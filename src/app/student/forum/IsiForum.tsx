...
export function IsiForum({ awal }: { awal: { me: Awaited<ReturnType<typeof getCurrentUser>>; diskusi: Awaited<ReturnType<typeof getForumDiscussions>> } }) {
  const [me, setMe] = useState<any>(awal.me)
  const [items, setItems] = useState<any[]>(awal.diskusi)
  ...
  if (isLoading) {
    return (
      <PemuatData pesan="Memuat forum diskusi..." />
    )
  }
