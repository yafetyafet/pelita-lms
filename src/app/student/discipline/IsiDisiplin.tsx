...
export function IsiDisiplin({ awal }: { awal: { pelanggaran: Awaited<ReturnType<typeof getStudentViolations>>; jenis: JenisPelanggaran[] } }) {
  const [violations, setViolations] = useState<any[]>(awal.pelanggaran)
  const [rules, setRules] = useState<JenisPelanggaran[]>(awal.jenis)
