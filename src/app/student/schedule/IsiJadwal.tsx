...
export function IsiJadwal({ awal }: { awal: { user: Awaited<ReturnType<typeof getCurrentUser>>; jadwal: Awaited<ReturnType<typeof getStudentSchedule>> } }) {
  const [currentUser, setCurrentUser] = useState<any>(awal.user)
  const [schedules, setSchedules] = useState<any[]>(awal.jadwal)
